---
title: "Getting Started with Autograder"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with Autograder}
...
The `autograder` package provides an automated testing framework for R programming 
assignments. It's designed to help students learn by providing immediate, detailed 
...
The `autograder()` function has several options:
...
After passing all tests, you can compare your implementation's performance 
...
- Read the [Student Guide](student-guide.html) for more detailed usage
- See [Instructor Guide](instructor-guide.html) if you're creating test cases
- Learn about [Data Files](data-files.html) for data analysis problems
- Understand [Authentication](authentication.html) for private repositories
- Check out [Performance Benchmarking](performance.html) for optimization tips
