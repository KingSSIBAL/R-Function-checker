...
vignette: >
  %\VignetteIndexEntry{Working with Data Files}
...
The autograder supports external data files in test cases. This allows instructors 
to create realistic data analysis problems where students work with CSV files, 
Excel spreadsheets, RDS objects, and more.
...
2. **Injection**: For each input, if a value is a string matching a data file, 
   it's replaced with the loaded data
...
2. **Use descriptive names** - `student_grades_2024.csv` not `data1.csv`
