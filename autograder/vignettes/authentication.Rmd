...
Uses public GitHub raw URLs without authentication. Test cases are publicly 
accessible but still protected through:
...
Uses GitHub API with personal access token for private repository access:
